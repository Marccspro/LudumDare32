...
import fr.veridiangames.main.game.entities.particles.ParticleSystem;
import fr.veridiangames.main.rendering.Texture;

public class PotatoGrenade extends Entity {
	...
	public PotatoGrenade(float x, float y, float force, float xd, float zd) {
		super(x, y);
		this.x = x - 0.5f;
		this.y = -0.7f;
		this.z = y;
