...
import fr.veridiangames.main.audio.AudioManager;
...
public class Main {
	...
	public static final String NAME = "The Tiny World of Potatoes"; 	// Call of potatoes
															// World of Potatoes
															// Game of Potatoes
															// The Tiny World of Potatoes
															// Get those potatoes !
															// My Life is Potato
	...
	public static void main(String[] args) {
		try {
			Display.setDisplayMode(new DisplayMode(1280, (int) (1280.0f / 16.0f*10.0f)));
